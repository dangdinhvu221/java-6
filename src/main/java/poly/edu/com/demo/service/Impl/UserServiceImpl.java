...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Users addUsers(String username, String password, String fullName, String email, String phone,
                          MultipartFile file, Date created, TypeRole typeRole, TypeGender typeGender, TypeStatus typeStatus, String address, Date birthDay) {
